...
const JobList = ({ jobs, handleJobClick }) => {
  return (
    <div className="w-full p-6 bg-white  overflow-y-auto max-h-96">
      {jobs.length === 0 ? (
        ...
        <ul>
          {jobs.map((job) => (
            <li
              key={job._id}
              className="bg-gray-600 mt-12 rounded-lg shadow-md hover:bg-gray-50 cursor-pointer transition duration-200 hover:shadow-lg"
